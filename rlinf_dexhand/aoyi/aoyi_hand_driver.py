...
def main():
    ...
    parser = argparse.ArgumentParser(description="Aoyi hand sine wave test")
    ...
    hand = AoyiHandDriver(port=args.port, node_id=args.node_id, baudrate=args.baudrate)
    hand.initialize()
    ...
    try:
        ...
        while True:
            ...
            action = np.full(AoyiHandDriver.NUM_DOFS, value)
            hand.command(action)
